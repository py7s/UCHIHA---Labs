...
// The backend is hosted on Render.com. Hardcoded, no user-tweakable
// settings.
const API_BASE = 'https://uchiha-backend-d1n7.onrender.com';
...
ipcMain.handle('launcher:downloadLauncherExe', async () => {
    try {
        ...
        const url = API_BASE + win.download_url;
